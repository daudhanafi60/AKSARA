...
exports.textMenu = (pushname) => {
    return `
Hi, ${pushname}! 👋️
*HAI INI MENU DARI BOT BUATAN DAUD HANAFI ^_^*
...
exports.textDonasi = () => {
    return `
Hai, terimakasih telah menggunakan bot ini, untuk mendukung bot ini kamu dapat membantu dengan berdonasi dengan cara kirim gopay ke nomor ini :
